...
var node_25 = nodes.createNode(node_25_data);
...
var node_34 = nodes.createNode(node_34_data);
...
var node_45 = nodes.createNode(node_45_data);
...
var node_55 = nodes.createNode(node_55_data);
...
var node_69 = nodes.createNode(node_69_data);
...
var node_87 = nodes.createNode(node_87_data);
...
var node_97 = nodes.createNode(node_97_data);
...
var node_104_data = {
	...
	fields: {'in': [
		...
		{name: 'blending', val: 1},
		{name: 'color'},
		{name: 'ambient', val: [object Object]},
		{name: 'map'},
...
var node_104 = nodes.createNode(node_104_data);
...
var node_121 = nodes.createNode(node_121_data);
...
var node_126 = nodes.createNode(node_126_data);
...
var node_134 = nodes.createNode(node_134_data);
...
var node_143 = nodes.createNode(node_143_data);
...
var node_169_data = {
	...
	fields: {'in': [
		{name: 'r', val: 1},
		{name: 'g'},
		{name: 'b', val: 0.3333333333333333},
	]},
	anim: {
	}
};
var node_169 = nodes.createNode(node_169_data);
...
var node_179_data = {
	...
	fields: {'in': [
		...
		{name: 'map'},
		{name: 'ambient', val: [object Object]},
		{name: 'specular', val: [object Object]},
...
var node_209 = nodes.createNode(node_209_data);
...
var node_215 = nodes.createNode(node_215_data);
...
var node_224 = nodes.createNode(node_224_data);
...
var node_231 = nodes.createNode(node_231_data);
...
var node_236 = nodes.createNode(node_236_data);
...
var node_243 = nodes.createNode(node_243_data);
...
var node_249 = nodes.createNode(node_249_data);
...
var connection_24 = nodes.createConnectionFromObject(connection_24_data);
var connection_42_data = {
	id: 42,
	from_node: 25, from: 'out',
	to_node: 34, to: 'in5'
};
var connection_42 = nodes.createConnectionFromObject(connection_42_data);
var connection_43_data = {
	id: 43,
	from_node: 25, from: 'out',
	to_node: 1, to: 'camera'
};
var connection_43 = nodes.createConnectionFromObject(connection_43_data);
var connection_44_data = {
	id: 44,
	from_node: 34, from: 'out',
	to_node: 14, to: 'children'
};
var connection_44 = nodes.createConnectionFromObject(connection_44_data);
var connection_54_data = {
	id: 54,
	from_node: 45, from: 'rgb',
	to_node: 1, to: 'bg_color'
};
var connection_54 = nodes.createConnectionFromObject(connection_54_data);
var connection_68_data = {
	id: 68,
	from_node: 55, from: 'out',
	to_node: 34, to: 'in0'
};
var connection_68 = nodes.createConnectionFromObject(connection_68_data);
var connection_76_data = {
	id: 76,
	from_node: 69, from: 'out',
	to_node: 55, to: 'geometry'
};
var connection_76 = nodes.createConnectionFromObject(connection_76_data);
...
var connection_96 = nodes.createConnectionFromObject(connection_96_data);
var connection_103_data = {
	id: 103,
	from_node: 97, from: 'out',
	to_node: 34, to: 'in4'
};
var connection_103 = nodes.createConnectionFromObject(connection_103_data);
var connection_120_data = {
	id: 120,
	from_node: 104, from: 'out',
	to_node: 55, to: 'material'
};
var connection_120 = nodes.createConnectionFromObject(connection_120_data);
var connection_130_data = {
	id: 130,
	from_node: 121, from: 'out',
	to_node: 126, to: 'in'
};
var connection_130 = nodes.createConnectionFromObject(connection_130_data);
var connection_131_data = {
	id: 131,
	from_node: 126, from: 'out',
	to_node: 87, to: 'y'
};
var connection_131 = nodes.createConnectionFromObject(connection_131_data);
var connection_132_data = {
	id: 132,
	from_node: 126, from: 'out',
	to_node: 87, to: 'z'
};
var connection_132 = nodes.createConnectionFromObject(connection_132_data);
var connection_133_data = {
	id: 133,
	from_node: 126, from: 'out',
	to_node: 87, to: 'x'
};
var connection_133 = nodes.createConnectionFromObject(connection_133_data);
var connection_156_data = {
	id: 156,
	from_node: 143, from: 'out',
	to_node: 34, to: 'in1'
};
var connection_156 = nodes.createConnectionFromObject(connection_156_data);
...
var connection_167 = nodes.createConnectionFromObject(connection_167_data);
var connection_168_data = {
	id: 168,
	from_node: 158, from: 'xyz',
	to_node: 143, to: 'rotation'
};
var connection_168 = nodes.createConnectionFromObject(connection_168_data);
...
var connection_208 = nodes.createConnectionFromObject(connection_208_data);
var connection_214_data = {
	id: 214,
	from_node: 209, from: 'out',
	to_node: 34, to: 'in3'
};
var connection_214 = nodes.createConnectionFromObject(connection_214_data);
var connection_223_data = {
	id: 223,
	from_node: 215, from: 'out',
	to_node: 1, to: 'postfx'
};
var connection_223 = nodes.createConnectionFromObject(connection_223_data);
var connection_230_data = {
	id: 230,
	from_node: 224, from: 'out',
	to_node: 215, to: 'in0'
};
var connection_230 = nodes.createConnectionFromObject(connection_230_data);
var connection_235_data = {
	id: 235,
	from_node: 231, from: 'out',
	to_node: 215, to: 'in1'
};
var connection_235 = nodes.createConnectionFromObject(connection_235_data);
var connection_242_data = {
	id: 242,
	from_node: 236, from: 'out',
	to_node: 215, to: 'in2'
};
var connection_242 = nodes.createConnectionFromObject(connection_242_data);
var connection_246_data = {
	id: 246,
	from_node: 243, from: 'out',
	to_node: 25, to: 'fov'
};
var connection_246 = nodes.createConnectionFromObject(connection_246_data);
var connection_252_data = {
	id: 252,
	from_node: 249, from: 'out',
	to_node: 25, to: 'far'
};
var connection_252 = nodes.createConnectionFromObject(connection_252_data);
